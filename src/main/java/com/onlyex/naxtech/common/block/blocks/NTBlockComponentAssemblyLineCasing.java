...
public class NTBlockComponentAssemblyLineCasing extends VariantBlock<NTBlockComponentAssemblyLineCasing.CasingTier> {
    public NTBlockComponentAssemblyLineCasing() {
        super(Material.IRON);
