...
public class NTBlockAdvancedAssemblyLineCasing extends VariantBlock<NTBlockAdvancedAssemblyLineCasing.CasingType> {


    public NTBlockAdvancedAssemblyLineCasing() {
        super(Material.IRON);
