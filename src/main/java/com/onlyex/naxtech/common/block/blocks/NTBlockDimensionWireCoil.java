 ...
 */
public class NTBlockDimensionWireCoil extends VariantActiveBlock<NTBlockDimensionWireCoil.CoilType> {

    public NTBlockDimensionWireCoil() {
    ...
    public void addInformation(@Nonnull ItemStack itemStack, @Nullable World worldIn, List<String> lines, @Nonnull ITooltipFlag tooltipFlag) {
        ...
        VariantItemBlock<CoilType, NTBlockDimensionWireCoil> itemBlock = (VariantItemBlock<CoilType, NTBlockDimensionWireCoil>) itemStack.getItem();
