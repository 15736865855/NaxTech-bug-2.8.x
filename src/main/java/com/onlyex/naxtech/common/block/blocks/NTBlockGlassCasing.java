...
public class NTBlockGlassCasing extends VariantActiveBlock<NTBlockGlassCasing.CasingType> {

    public NTBlockGlassCasing() {
...
//        }
    ...
    public void addInformation(@Nonnull ItemStack stack, @Nullable World player, @Nonnull List<String> tooltip, @Nonnull ITooltipFlag advanced) {
        ...
        VariantItemBlock<CasingType, NTBlockGlassCasing> itemBlock = (VariantItemBlock<NTBlockGlassCasing.CasingType, NTBlockGlassCasing>) stack.getItem();
        IBlockState stackState = itemBlock.getBlockState(stack);
        NTBlockGlassCasing.CasingType casingType =  this.getState(stackState);
