...
public class NTMetaTileEntityCrystallizationCrucible extends MultiMapMultiblockController implements IHeatingCoil {

    private int temperature;

    public NTMetaTileEntityCrystallizationCrucible(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, new RecipeMap[]{
                NTRecipeMaps.CRYSTALLIZATION_RECIPES,
                NTRecipeMaps.CRYSTALLIZER_RECIPES});
        this.recipeMapWorkable = new HeatingCoilRecipeLogic(this);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity holder) {
        return new NTMetaTileEntityCrystallizationCrucible(metaTileEntityId);
    }
    ...
    protected OrientedOverlayRenderer getFrontOverlay() {
        return NTTextures.CRYSTALLIZATION_CRUCIBLE_OVERLAY;
    }
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        ...
        MultiblockShapeInfo.Builder builder = MultiblockShapeInfo.builder()
                ...
                .where('S', NTMetaTileEntities.CRYSTALLIZATION_CRUCIBLE, EnumFacing.SOUTH)
