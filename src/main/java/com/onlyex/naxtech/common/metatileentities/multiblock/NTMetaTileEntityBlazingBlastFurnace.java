...
public class NTMetaTileEntityBlazingBlastFurnace extends RecipeMapMultiblockController implements IHeatingCoil {
    private int blastFurnaceTemperature;
    protected static int heatingCoilLevel;
    protected int heatingCoilDiscount;

    public NTMetaTileEntityBlazingBlastFurnace(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity metaTileEntityHolder) {
        return new NTMetaTileEntityBlazingBlastFurnace(this.metaTileEntityId);
    }
    ...
    private static IBlockState getCasingState() {
        return NTMetaBlocks.MACHINE_CASING.getState(NTBlockMachinelCasing.CasingType.ADVANCED_INVAR_CASING);
    }
    ...
    protected class BlazingBlastRecipeLogic extends HeatingCoilRecipeLogic {
        ...
        private final NTMetaTileEntityBlazingBlastFurnace blastFurnace;
        public BlazingBlastRecipeLogic(RecipeMapMultiblockController tileEntity) {
            super(tileEntity);
            this.blastFurnace = (NTMetaTileEntityBlazingBlastFurnace) tileEntity;
        }
