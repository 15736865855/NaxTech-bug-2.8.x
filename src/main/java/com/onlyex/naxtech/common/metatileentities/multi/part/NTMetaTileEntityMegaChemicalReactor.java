...
public class NTMetaTileEntityMegaChemicalReactor extends GlassTierMultiblockController {
    public NTMetaTileEntityMegaChemicalReactor(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new NTMetaTileEntityMegaChemicalReactor(metaTileEntityId);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World player, @Nonnull List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("naxtech.machine.mega_chemical_reactor.tooltip.1"));
        tooltip.add(I18n.format("naxtech.machine.mega_chemical_reactor.tooltip.2"));
    }
    ...
    protected void addDisplayText(List<ITextComponent> textList) {
        ...
        if (isStructureFormed()) {
            ...
            if (energyContainer != null && energyContainer.getEnergyCapacity() > 0L) {
                ...
                textList.add(2, new TextComponentTranslation("naxtech.machine.multiblock.max_parallel", 256));
                textList.add(1, new TextComponentTranslation("naxtech.machine.multiblock.max_voltage", voltageName));
            }
        }
    }
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        ...
        if (Blocks.AIR != null) {
            builder = MultiblockShapeInfo.builder()
                    ...
                    .where('S', NTMetaTileEntities.MEGA_CHEMICAL_REACTOR, EnumFacing.SOUTH)
        ...
        NTAPI.MAP_GLASS_SHAPE_INFO.entrySet().stream()
    ...
    private static class MegaChemicalReactorWorkableHandler extends MultiblockRecipeLogic {
