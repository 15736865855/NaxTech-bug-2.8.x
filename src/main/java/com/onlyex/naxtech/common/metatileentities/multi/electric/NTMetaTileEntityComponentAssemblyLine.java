...
import com.onlyex.naxtech.common.block.blocks.NTBlockAdvancedAssemblyLineCasing;
...
public class NTMetaTileEntityComponentAssemblyLine extends RecipeMapMultiblockController {
    private int casingTier;

    public NTMetaTileEntityComponentAssemblyLine(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, NTRecipeMaps.COMPONENT_ASSEMBLY_LINE_RECIPES);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new NTMetaTileEntityComponentAssemblyLine(metaTileEntityId);
    }
    ...
    private IBlockState getSecondCasingState() {
        return NTMetaBlocks.ADVANCED_ASSEMBLY_LINE_CASING.getState(NTBlockAdvancedAssemblyLineCasing.CasingType.ASSEMBLY_LINE_CASING);
    }

    private IBlockState getThirdCasingState() {
        return NTMetaBlocks.ADVANCED_ASSEMBLY_LINE_CASING.getState(NTBlockAdvancedAssemblyLineCasing.CasingType.FILTER_CASING);
    }

    private IBlockState getGlassState() {
        return NTMetaBlocks.GLASS_CASING.getState(NTBlockGlassCasing.CasingType.OS_BORON_SILICATE_GLASS_BLOCK);
    }
    ...
    private IBlockState getPipeCasingState() {
        return NTMetaBlocks.PIPELINE_CASING.getState(NTBlockPipelinelCasing.CasingType.PBI);
    }
