...
public class NTMetaTileEntityCompactCyclotron extends RecipeMapMultiblockController implements IFastRenderMetaTileEntity {
    ...
    public NTMetaTileEntityCompactCyclotron(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, NTRecipeMaps.CYCLOTRON_RECIPES);
    }
    
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new NTMetaTileEntityCompactCyclotron(this.metaTileEntityId);
    }
    ...
    private static IBlockState getCasingState() {
        return NTMetaBlocks.MACHINE_CASING_A.getState(NTBlockMachinelCasingA.CasingType.CYCLOTRON_CASING);
    }

    private static IBlockState getCoilState() {
        return NTMetaBlocks.MACHINE_CASING_A.getState(NTBlockMachinelCasingA.CasingType.CYCLOTRON_COIL);
    }
    ...
    public ICubeRenderer getBaseTexture(IMultiblockPart iMultiblockPart) {
        return NTTextures.CYCLOTRON_CASING;
    }

    @SideOnly(Side.CLIENT)
    @Nonnull
    protected ICubeRenderer getFrontOverlay() {
        return NTTextures.CYCLOTRON_OVERLAY;
    }
    ...
    public void renderMetaTileEntity(double x, double y, double z, float partialTicks) {
        if (this.color != null && MinecraftForgeClient.getRenderPass() == 0) {
            int c = this.color;
            BloomEffectUtil.requestCustomBloom(RENDER_HANDLER, (buffer) -> {//todo 2.9
    ...
    public void addInformation(ItemStack stack, @Nullable World player, @Nonnull List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("naxtech.machine.compact_cyclotron.tooltip.1"));
        tooltip.add(I18n.format("naxtech.machine.compact_cyclotron.tooltip.2"));
        tooltip.add(I18n.format("naxtech.machine.compact_cyclotron.tooltip.3"));
    }
}