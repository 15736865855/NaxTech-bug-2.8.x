...
import com.onlyex.naxtech.common.block.blocks.NTBlockActiveMultiblockCasing;
...
public class NTMetaTileEntityFlotationFactory extends RecipeMapMultiblockController {

    public NTMetaTileEntityFlotationFactory(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, NTRecipeMaps.FLOTATION_FACTORY_RECIPES);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new NTMetaTileEntityFlotationFactory(metaTileEntityId);
    }
    ...
    private static IBlockState getCasingState() {
        return NTMetaBlocks.CONTROL_CASING.getState(NTBlockControlCasing.CasingType.FLOTATION_CASING);
    }
    private static IBlockState getGlassState() {
        return NTMetaBlocks.GLASS_CASING.getState(NTBlockGlassCasing.CasingType.W_BORON_SILICATE_GLASS_BLOCK);
    }
    private static IBlockState getPipeState() {
        return NTMetaBlocks.CONTROL_CASING.getState(NTBlockControlCasing.CasingType.FLOTATION_CASING_PIPE);
    }
    private static IBlockState getIntakeState() {
        return NTMetaBlocks.ACTIVE_MULTIBLOCK_CASING.getState(NTBlockActiveMultiblockCasing.CasingType.FLOTATION_INTAKE_CASING);
    }
    private static IBlockState getGearBoxState() {
        return NTMetaBlocks.CONTROL_CASING.getState(NTBlockControlCasing.CasingType.FLOTATION_CASING_GEARBOX);
    }
