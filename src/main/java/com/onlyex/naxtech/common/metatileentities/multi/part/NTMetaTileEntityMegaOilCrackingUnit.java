...
public class NTMetaTileEntityMegaOilCrackingUnit extends GlassTierMultiblockController {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new NTMetaTileEntityMegaOilCrackingUnit(metaTileEntityId);
    }
    ...
    private void initMap() {
        ...
        List<IBlockState> listGlass = NTAPI.MAP_GLASS_SHAPE_INFO.entrySet().stream()
        ...
        //finalListGlass = NTUniverUtil.consistentList(listGlass, maxLeng); TODO

        init = true;
    }

    public NTMetaTileEntityMegaOilCrackingUnit(ResourceLocation metaTileEntityId) {
    ...
    public void addInformation(ItemStack stack, @Nullable World player, @Nonnull List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("naxtech.machine.mega_oil_cracking_unit.tooltip.1"));
        tooltip.add(I18n.format("naxtech.machine.mega_oil_cracking_unit.tooltip.2"));
        tooltip.add(I18n.format("naxtech.machine.mega_oil_cracking_unit.tooltip.3"));
    }
    ...
    protected void addDisplayText(List<ITextComponent> textList) {
        ...
        if (isStructureFormed()) {
            ...
            if (energyContainer != null && energyContainer.getEnergyCapacity() > 0L) {
                ...
                textList.add(2, new TextComponentTranslation("naxtech.machine.multiblock.max_parallel", getMaxParallel(heatingCoilLevel)));
                textList.add(2, new TextComponentTranslation("naxtech.machine.multiblock.max_voltage", voltageName));
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        ...
        if (Blocks.AIR != null) {
            builder = MultiblockShapeInfo.builder()
                    ...
                    .where('S', NTMetaTileEntities.MEGA_OIL_CRACKING_UNIT, EnumFacing.SOUTH)
    ...
    private class MegaCrackingUnitWorkableHandler extends MultiblockRecipeLogic {
        ...
        public MegaCrackingUnitWorkableHandler(NTMetaTileEntityMegaOilCrackingUnit tileEntity) {
            super(tileEntity);
        }
        ...
        protected void modifyOverclockPost(int[] resultOverclock, @Nonnull IRecipePropertyStorage storage) {
            ...
            int coilTier = ((NTMetaTileEntityMegaOilCrackingUnit) metaTileEntity).getCoilTier();
            if (coilTier <= 0)
                return;
