...
public class NTMetaTileEntityPreciseAssembler extends MultiMapMultiblockController {
    ...
    public NTMetaTileEntityPreciseAssembler(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new NTMetaTileEntityPreciseAssembler(metaTileEntityId);
    }
    ...
    private void initMap() {
        ...
        finalListInternalCasing = NTUniverUtil.consistentList(ListInternalCasing, maxLeng);
    ...
    protected void formStructure(PatternMatchContext context) {
        ...
        this.InternalCasingTier = NTUniverUtil.getOrDefault(() -> InternalCasingTier instanceof WrappedIntTier,
