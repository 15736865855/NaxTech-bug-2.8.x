...
public class NTMetaTileEntityPlasmaCVDUnit extends RecipeMapMultiblockController {
    public NTMetaTileEntityPlasmaCVDUnit(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, NTRecipeMaps.PLASMA_CVD_RECIPES);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new NTMetaTileEntityPlasmaCVDUnit(metaTileEntityId);
    }
