...
public class NTMetaTileEntityLargeVacuumChamber extends GCYMRecipeMapMultiblockController {
    public NTMetaTileEntityLargeVacuumChamber(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, new RecipeMap[]{
                NTRecipeMaps.VACUUM_CHAMBER_RECIPES,
                NTRecipeMaps.ULTRAVIOLET_LAMP_CHAMBER_RECIPES});
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new NTMetaTileEntityLargeVacuumChamber(metaTileEntityId);
    }
    ...
    private static IBlockState getCasingState() {
        return null;//NTMetaBlocks.EP_MULTIBLOCK_CASING_B.getState(EPBlockMultiblockCasingB.CasingType.BABBITT_ALLOY_CASING);todo
    }
    ...
    public ICubeRenderer getBaseTexture(IMultiblockPart iMultiblockPart) {
        return NTTextures.BABBITT_ALLOY_CASING;
    }
}
