...
public class NTMetaTileEntityDangoteDistillery extends MultiMapMultiblockController {

    public NTMetaTileEntityDangoteDistillery(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, new RecipeMap[]{
                RecipeMaps.DISTILLERY_RECIPES,
                RecipeMaps.DISTILLATION_RECIPES,
                NTRecipeMaps.MOLECULAR_DISTILLATION_RECIPES
        });
        this.recipeMapWorkable = new DangoteDistilleryRecipeLogic(this);
    }

    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new NTMetaTileEntityDangoteDistillery(this.metaTileEntityId);
    }
    ...
    private static IBlockState getCasingState() {
        return NTMetaBlocks.MACHINE_CASING_A.getState(NTBlockMachinelCasingA.CasingType.HG_1223_CASING);
    }
    ...
    protected static class DangoteDistilleryRecipeLogic extends MultiblockRecipeLogic {
