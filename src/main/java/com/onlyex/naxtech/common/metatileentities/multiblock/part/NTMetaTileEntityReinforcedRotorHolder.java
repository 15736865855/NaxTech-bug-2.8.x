...
public class NTMetaTileEntityReinforcedRotorHolder extends MetaTileEntityMultiblockPart implements IMultiblockAbilityPart<IReinforcedRotorHolder>, IReinforcedRotorHolder {
    ...
    public NTMetaTileEntityReinforcedRotorHolder(ResourceLocation metaTileEntityId, int tier) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new NTMetaTileEntityReinforcedRotorHolder(metaTileEntityId, getTier());
    }
    ...
    public MultiblockAbility<IReinforcedRotorHolder> getAbility() {
        return NTMultiblockAbility.REINFORCED_ROTOR_MULTIBLOCK_ABILITY;
    }
    ...
    public void setRotor(ItemStack itemStack) {
        ...
        if (!getWorld().isRemote) {
            writeCustomData(NTDataCode.NT_CHANNEL_5, buf -> buf.writeInt(rotorColor));
            markDirty();
        }
    }
    ...
    public void receiveCustomData(int dataId, PacketBuffer buf) {
        ...
        } else if (dataId == NTDataCode.NT_CHANNEL_5) {
