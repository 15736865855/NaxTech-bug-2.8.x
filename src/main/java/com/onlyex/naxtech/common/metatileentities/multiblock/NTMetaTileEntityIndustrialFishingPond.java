...
import com.onlyex.naxtech.api.capability.impl.FishingPondLogic;
...
public class NTMetaTileEntityIndustrialFishingPond extends MultiblockWithDisplayBase implements IDataInfoProvider {
    ...
    public NTMetaTileEntityIndustrialFishingPond(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new NTMetaTileEntityIndustrialFishingPond(metaTileEntityId);
    }
    ...
    private static IBlockState getCasingState() {
        return NTMetaBlocks.MACHINE_CASING.getState(NTBlockMachinelCasing.CasingType.BREEDING_CASING);
    }

    @SideOnly(Side.CLIENT)
    @Override
    public ICubeRenderer getBaseTexture(IMultiblockPart iMultiblockPart) {
        return NTTextures.BREEDING_CASING;
    }
    ...
    protected void addDisplayText(List<ITextComponent> textList) {
        ...
        if (logic.getMode() == 1)
            textList.add(new TextComponentTranslation("naxtech.multiblock.industrial_fisher.mode1"));
        else if (logic.getMode() == 2)
            textList.add(new TextComponentTranslation("naxtech.multiblock.industrial_fisher.mode2"));
        else
            textList.add(new TextComponentTranslation("naxtech.multiblock.industrial_fisher.mode0"));
        ...
        if (logic.isInventoryFull())
            textList.add(new TextComponentTranslation("naxtech.multiblock.industrial_fisher.inv_full").setStyle(new Style().setColor(TextFormatting.RED)));
    }
    ...
    public List<ITextComponent> getDataInfo() {
        ...
        list.add(new TextComponentTranslation("naxtech.machine.multiblock.mode", logic.getMode()));
        return list;
    }
