...
public class NTMetaTileEntityIndustrialDrill extends RecipeMapMultiblockController {
    protected BlockPos targetBlock = null;

    public NTMetaTileEntityIndustrialDrill(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, NTRecipeMaps.DRILLING_RECIPES);
        this.recipeMapWorkable = new IndustrialDrillWorkableHandler(this);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new NTMetaTileEntityIndustrialDrill(metaTileEntityId);
    }
    ...
    protected void initializeAbilities() {
        ...
        this.inputInventory = new NotifiableItemStackHandler(null,1, this, false);
    }
    ...
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start()
                ...
                .where('D', states())//NTMetaBlocks.EP_MULTIBLOCK_CASING.getState(EPBlockMultiblockCasing.CasingType.DRILL_HEAD)TODO
    ...
    protected ICubeRenderer getFrontOverlay() {
        return NTTextures.INDUSTRIAL_DRILL_OVERLAY;
    }

    @Override
    public void addInformation(ItemStack stack, @Nullable World player, @Nonnull List<String> tooltip, boolean advanced) {
        super.addInformation(stack, player, tooltip, advanced);
        tooltip.add(I18n.format("naxtech.multiblock.industrial_drill.tooltip.1"));
        tooltip.add(I18n.format("naxtech.multiblock.industrial_drill.tooltip.2"));
    }
    ...
    protected static class IndustrialDrillWorkableHandler extends MultiblockRecipeLogic {
        ...
        @Nonnull
        @Override
        public NTMetaTileEntityIndustrialDrill getMetaTileEntity() {
            return (NTMetaTileEntityIndustrialDrill) super.getMetaTileEntity();
        }
        ...
        protected boolean setupAndConsumeRecipeInputs(@Nonnull Recipe recipe, @Nonnull IItemHandlerModifiable importInventory) {
            ...
            if (result && !recipe.getInputs().get(0).isNonConsumable()) {
                NTMetaTileEntityIndustrialDrill drill = getMetaTileEntity();
                if (drill != null) {
