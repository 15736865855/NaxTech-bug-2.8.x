...
//TODO 添加耗能显示 更换方块
public class NTMetaTileEntityIntegratedOreFactory extends MultiblockWithDisplayBase implements IDataInfoProvider {
    ...
    public NTMetaTileEntityIntegratedOreFactory(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new NTMetaTileEntityIntegratedOreFactory(metaTileEntityId);
    }
    ...
    private static IBlockState getCasingAState() {
        return NTMetaBlocks.MACHINE_CASING.getState(NTBlockMachinelCasing.CasingType.IRIDIUM);
    }
    ...
    public ICubeRenderer getBaseTexture(IMultiblockPart iMultiblockPart) {
        if ((iMultiblockPart instanceof MetaTileEntityItemBus && ((MetaTileEntityItemBus)iMultiblockPart).getExportItems().getSlots() == 0)
            ...
            return NTTextures.IRIDIUM_CASING;
        } else {
    ...
    protected void addDisplayText(List<ITextComponent> textList) {
        ...
        if (isStructureFormed()) {
            ...
            NTLog.logger.info(logic.isActive());
            ...
            switch (logic.getMode()) {
                case 0 -> textList.add(new TextComponentTranslation("naxtech.machine.integrated_ore_factory.mode.0"));

                case 1 -> textList.add(new TextComponentTranslation("naxtech.machine.integrated_ore_factory.mode.1"));

                case 2 -> textList.add(new TextComponentTranslation("naxtech.machine.integrated_ore_factory.mode.2"));

                case 3 -> textList.add(new TextComponentTranslation("naxtech.machine.integrated_ore_factory.mode.3"));

                case 4 -> textList.add(new TextComponentTranslation("naxtech.machine.integrated_ore_factory.mode.4"));

                default -> textList.add(new TextComponentTranslation("naxtech.machine.integrated_ore_factory.mode.error"));
            }
            if (!drainEnergy(true)) {
    ...
    public void addInformation(ItemStack stack, @Nullable World world, @Nonnull List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("naxtech.machine.integrated_ore_factory.tooltip.1"));
        if (Keyboard.isKeyDown(Keyboard.KEY_LSHIFT)) {
            tooltip.add(I18n.format("naxtech.machine.integrated_ore_factory.tooltip_shift.1"));
            tooltip.add(I18n.format("naxtech.machine.integrated_ore_factory.tooltip_shift.2"));
        }else {
    ...
    public final boolean onScrewdriverClick(EntityPlayer playerIn, EnumHand hand, EnumFacing facing, CuboidRayTraceResult hitResult) {
        if (playerIn.isSneaking()) {
            ...
            if (playerIn.getEntityWorld().isRemote) {
                playerIn.sendMessage( new TextComponentTranslation("naxtech.machine.integrated_ore_factory.void." + logic.isVoidStone()));
            }
        }else {
    ...
    public List<ITextComponent> getDataInfo() {
        ...
        if (logic.getMode() < 5 && logic.getMode() >= 0) {
            list.add(new TextComponentTranslation("naxtech.machine.integrated_ore_factory.mode." + logic.getMode()));
        }
        return list;
    }
}
