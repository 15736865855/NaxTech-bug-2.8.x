...
public class NTMetaTileEntityLargeSteamCompressor extends RecipeMapSteamMultiblockController {
    private static final int PARALLEL_LIMIT = 8;

    public NTMetaTileEntityLargeSteamCompressor(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity metaTileEntityHolder) {
        return new NTMetaTileEntityLargeSteamCompressor(this.metaTileEntityId);
    }
