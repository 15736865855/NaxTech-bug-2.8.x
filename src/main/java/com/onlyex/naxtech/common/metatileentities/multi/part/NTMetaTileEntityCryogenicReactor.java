...
public class NTMetaTileEntityCryogenicReactor extends RecipeMapMultiblockController {
    public NTMetaTileEntityCryogenicReactor(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new NTMetaTileEntityCryogenicReactor(metaTileEntityId);
    }
