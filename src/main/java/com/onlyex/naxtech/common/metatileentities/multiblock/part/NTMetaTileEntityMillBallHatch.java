...
public class NTMetaTileEntityMillBallHatch extends MetaTileEntityMultiblockPart implements IMultiblockAbilityPart<IBall>, IBall{

    private final ItemBallHolder ballHolder;

    private boolean needUpdate;

    public NTMetaTileEntityMillBallHatch(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new NTMetaTileEntityMillBallHatch(this.metaTileEntityId);
    }
    ...
    public void renderMetaTileEntity(CCRenderState renderState, Matrix4 translation, IVertexOperation[] pipeline) {
        ...
        if (this.shouldRenderOverlay()){
            NTTextures.MULTIPART_BALL_HATCH.renderSided(getFrontFacing(), renderState, translation, pipeline);
        }
    }
    ...
    protected ModularUI createUI(EntityPlayer entityPlayer) {
        ModularUI.Builder builder = ModularUI.builder(GuiTextures.BACKGROUND, 176, 209)
                ...
                .widget(new LabelWidget(88,20,"naxtech.multipart.ball.only")
                        .setXCentered(true));
    ...
    public void addInformation(ItemStack stack, @Nullable World world, @Nonnull List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("naxtech.multipart.ball.only"));
    }
    ...
    public MultiblockAbility<IBall> getAbility() {
        return NTMultiblockAbility.GRINDBALL_MULTIBLOCK_ABILITY;
    }
    ...
    private class ItemBallHolder extends ItemStackHandler {
        ...
        private int getBallTier(){
            if(getBallStack() == null)
                ...
                return NTMetaItems.GRINDBALL_SOAPSTONE.isItemEqual(getBallStack()) ? 1 : 2;
        }
