...
public class NTLargeTurbineWorkableHandler extends MultiblockFuelRecipeLogic {
    ...
    public NTLargeTurbineWorkableHandler(RecipeMapMultiblockController metaTileEntity, int tier) {
    ...
    public long getMaxVoltage() {
        IRotorHolder rotorHolder = ((NTMetaTileEntityLargeTurbine) metaTileEntity).getRotorHolder();
