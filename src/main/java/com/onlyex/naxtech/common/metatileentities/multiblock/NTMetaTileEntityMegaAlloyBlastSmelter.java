...
public class NTMetaTileEntityMegaAlloyBlastSmelter extends GlassTierMultiblockController implements IHeatingCoil {
    ...
    public NTMetaTileEntityMegaAlloyBlastSmelter(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new NTMetaTileEntityMegaAlloyBlastSmelter(metaTileEntityId);
    }
    ...
    protected BlockPattern createStructurePattern() {
     ...
     private static IBlockState getBoilerState() {
        return NTMetaBlocks.PIPELINE_CASING.getState(NTBlockPipelinelCasing.CasingType.ALLOY_SMELTING_PIPE_CASING);
     }
    ...
    public void addInformation(ItemStack stack, @Nullable World player, @Nonnull List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("naxtech.machine.mega_alloy_blast_smelter.tooltip.1"));
        tooltip.add(I18n.format("naxtech.machine.mega_alloy_blast_smelter.tooltip.2"));
        tooltip.add(I18n.format("naxtech.machine.mega_alloy_blast_smelter.tooltip.3"));
    }
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        ...
        if (Blocks.AIR != null) {
            builder = MultiblockShapeInfo.builder()
                    ...
                    .where('S', NTMetaTileEntities.MEGA_ALLOY_BLAST_SMELTER, EnumFacing.SOUTH)
