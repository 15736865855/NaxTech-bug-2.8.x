...
import com.onlyex.naxtech.common.block.blocks.NTBlockCrucibleCasing;
...
public class NTMetaTileEntityNanoscaleFabricator extends RecipeMapMultiblockController {

    private int temperature;

    public NTMetaTileEntityNanoscaleFabricator(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, NTRecipeMaps.MOLECULAR_BEAM_RECIPES);
        this.recipeMapWorkable = new NanoscaleFabricatorWorkableHandler(this);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity metaTileEntityHolder) {
        return new NTMetaTileEntityNanoscaleFabricator(metaTileEntityId);
    }
    ...
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start()
                ...
                .where('A', states(NTMetaBlocks.MACHINE_CASING_A.getState(NTBlockMachinelCasingA.CasingType.ADVANCED_SUBSTRATE_CASING)))
                .where('#', air())
                .where(' ', any())
                .build();
    }
    ...
    private TraceabilityPredicate cruciblePredicate() {
        return new TraceabilityPredicate(blockWorldState -> {
            ...
            if (block instanceof NTBlockCrucibleCasing) {
                int storedTemperature = blockWorldState.getMatchContext().getOrPut("Temperature", 0);
                blockWorldState.getMatchContext().set("Temperature", ((NTBlockCrucibleCasing) block).getState(state).getTemperature() + storedTemperature);
            ...
            return false;
        }, () -> Arrays.stream(NTBlockCrucibleCasing.CrucibleType.values())
                .sorted(Comparator.comparingInt(NTBlockCrucibleCasing.CrucibleType::getTemperature))
                .map(type -> new BlockInfo(NTMetaBlocks.CRUCIBLE_CASING.getState(type), null))
    ...
    protected ICubeRenderer getFrontOverlay() {
        return NTTextures.NANOSCALE_FABRICATOR_OVERLAY;
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World player, @Nonnull List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("naxtech.machine.nanoscale_fabricator.tooltip.1"));
    }
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        ...
        MultiblockShapeInfo.Builder builder = MultiblockShapeInfo.builder()
                ...
                .aisle("   TTT   ", "   TIT   ", "   TCT   ", "         ")
                .where('S', NTMetaTileEntities.NANOSCALE_FABRICATOR, EnumFacing.SOUTH)
                ...
                .where('J', NTMetaBlocks.MACHINE_CASING_A.getState(NTBlockMachinelCasingA.CasingType.ADVANCED_SUBSTRATE_CASING))
        ...
        for (NTBlockCrucibleCasing.CrucibleType crucibleType : NTBlockCrucibleCasing.CrucibleType.values()) {
            shapeInfos.add(builder.where('C', NTMetaBlocks.CRUCIBLE_CASING.getState(crucibleType)).build());
        }
