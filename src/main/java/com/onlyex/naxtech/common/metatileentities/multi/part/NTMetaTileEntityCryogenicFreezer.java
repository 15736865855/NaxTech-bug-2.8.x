...
public class NTMetaTileEntityCryogenicFreezer extends RecipeMapMultiblockController {
    public NTMetaTileEntityCryogenicFreezer(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, VACUUM_RECIPES);
        this.recipeMapWorkable = new NTMetaTileEntityCryogenicFreezer.CryogenicFreezerRecipeLogic(this);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity metaTileEntityHolder) {
        return new NTMetaTileEntityCryogenicFreezer(this.metaTileEntityId);
    }
    ...
    protected IBlockState getCasingState() {
        return NTMetaBlocks.MACHINE_CASING.getState(NTBlockMachinelCasing.CasingType.ADVANCED_ALUMINIUM_CASING);
    }
    ...
    protected class CryogenicFreezerRecipeLogic extends MultiblockRecipeLogic {
        private final NTMetaTileEntityCryogenicFreezer combustionEngine;

        public CryogenicFreezerRecipeLogic(RecipeMapMultiblockController tileEntity) {
            super(tileEntity);
            this.combustionEngine = (NTMetaTileEntityCryogenicFreezer) tileEntity;
        }
