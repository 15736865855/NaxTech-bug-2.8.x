...
public class NTMetaTileEntityFracker extends MultiblockWithDisplayBase implements IWorkable, ITieredMetaTileEntity {
    public static final FluidStack FRACKING_FLUID = NTMaterials.FracturingFluid.getFluid(1);
    ...
    public NTMetaTileEntityFracker(ResourceLocation metaTileEntityId, int tier) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new NTMetaTileEntityFracker(this.metaTileEntityId, this.tier);
    }
    ...
    protected ICubeRenderer getFrontOverlay() {
        return NTTextures.FRACKER_OVERLAY;
    }
