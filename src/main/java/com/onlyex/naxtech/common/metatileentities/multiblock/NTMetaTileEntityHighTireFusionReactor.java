...
public class NTMetaTileEntityHighTireFusionReactor extends RecipeMapMultiblockController implements IFastRenderMetaTileEntity {
    ...
    public NTMetaTileEntityHighTireFusionReactor(ResourceLocation metaTileEntityId, int tier, IBlockState casingState, IBlockState glassState, IBlockState coilState) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new NTMetaTileEntityHighTireFusionReactor(metaTileEntityId, tier, casingState, glassState, coilState);
    }
    ...
    private class FusionRecipeLogic extends MultiblockRecipeLogic {
        ...
        public FusionRecipeLogic(NTMetaTileEntityHighTireFusionReactor tileEntity) {
            super(tileEntity);
        }
    ...
    public void renderMetaTileEntity(double x, double y, double z, float partialTicks) {
        if (color != null && MinecraftForgeClient.getRenderPass() == 0) {
            final int c = color;
            BloomEffectUtil.requestCustomBloom(RENDER_HANDLER, (buffer) -> {//TODO
