...
public class NTMetaTileEntityPlasmaCondenser extends RecipeMapMultiblockController {
    public NTMetaTileEntityPlasmaCondenser(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, NTRecipeMaps.PLASMA_CONDENSER_RECIPES);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new NTMetaTileEntityPlasmaCondenser(metaTileEntityId);
    }
    ...
    private static IBlockState getCasingState() {
        return null;//NTMetaBlocks.EP_MULTIBLOCK_CASING_B.getState(EPBlockMultiblockCasingB.CasingType.ZIRCONIUM_CARBIDE_CASING);TODO
    }
    ...
    public ICubeRenderer getBaseTexture(IMultiblockPart iMultiblockPart) {
        return NTTextures.ZIRCONIUM_CARBIDE_CASING;
    }
