...
public class NTMetaTileEntityCatalystHatch extends MetaTileEntityMultiblockNotifiablePart implements IMultiblockAbilityPart<ICatalyst> ,ICatalyst{
    ...
    public NTMetaTileEntityCatalystHatch(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new NTMetaTileEntityCatalystHatch(this.metaTileEntityId);
    }
    ...
    public void renderMetaTileEntity(CCRenderState renderState, Matrix4 translation, IVertexOperation[] pipeline) {
        ...
        if (this.shouldRenderOverlay()){
            NTTextures.MULTIPART_CATALYST_HATCH.renderSided(getFrontFacing(), renderState, translation, pipeline);
        }
    ...
    protected ModularUI createUI(EntityPlayer entityPlayer) {
        ModularUI.Builder builder = ModularUI.builder(GuiTextures.BACKGROUND, 176, 209)
                ...
                .widget(new LabelWidget(88,20,"naxtech.multipart.catalyst.only")
                        .setXCentered(true));
    ...
    public MultiblockAbility<ICatalyst> getAbility() {
        return NTMultiblockAbility.CATALYST_MULTIBLOCK_ABILITY;
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World world, @Nonnull List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("naxtech.multipart.catalyst.only"));
    }
