...
public class NTMetaTileEntityQuantumForceTransformer extends RecipeMapMultiblockController implements IFastRenderMetaTileEntity {
    ...
    public NTMetaTileEntityQuantumForceTransformer(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new NTMetaTileEntityQuantumForceTransformer(metaTileEntityId);
    }
