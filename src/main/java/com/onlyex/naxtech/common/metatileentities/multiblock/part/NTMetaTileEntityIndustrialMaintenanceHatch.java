...
public class NTMetaTileEntityIndustrialMaintenanceHatch extends MetaTileEntityMultiblockPart implements IMultiblockAbilityPart<IIndustrialMaintenance>, IIndustrialMaintenance {
    ...
    private final List<IMaintenance> list = new ArrayList<>();
    ...
    public NTMetaTileEntityIndustrialMaintenanceHatch(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, 4);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new NTMetaTileEntityIndustrialMaintenanceHatch(metaTileEntityId);
    }

    @Override
    protected void initializeInventory() {
        super.initializeInventory();
        this.itemStackHandler = new TapeItemStackHandler(null,1);
            ...
            if (((problems >> index) & 1) == 0) {
                ...
                switch (index) {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        toolsToMatch.set(6, ToolClasses.SWORD);//NTToolClasses.BENDING_CYLINDER
                        break;
                }
            }
        }
    ...
    public MultiblockAbility<IIndustrialMaintenance> getAbility() {
        return NTMultiblockAbility.INDUSTRIAL_MAINTENANCE_MULTIBLOCK_ABILITY;
    }
