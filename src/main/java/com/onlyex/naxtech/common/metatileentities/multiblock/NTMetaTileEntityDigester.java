...
public class NTMetaTileEntityDigester extends RecipeMapMultiblockController {
    public NTMetaTileEntityDigester(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, NTRecipeMaps.DIGESTER_RECIPES);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new NTMetaTileEntityDigester(metaTileEntityId);
    }
