...
public class NTMetaTileEntityIonImplantater extends RecipeMapMultiblockController {
    public NTMetaTileEntityIonImplantater(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, NTRecipeMaps.ION_IMPLANTATER_RECIPES);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new NTMetaTileEntityIonImplantater(metaTileEntityId);
    }
