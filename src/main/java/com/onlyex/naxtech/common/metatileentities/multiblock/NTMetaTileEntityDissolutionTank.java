...
public class NTMetaTileEntityDissolutionTank extends RecipeMapMultiblockController {
    public NTMetaTileEntityDissolutionTank(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, NTRecipeMaps.DISSOLUTION_TANK_RECIPES);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new NTMetaTileEntityDissolutionTank(metaTileEntityId);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World world, @Nonnull List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("naxtech.machine.dissolution_tank.tooltip.1"));
    }
}
