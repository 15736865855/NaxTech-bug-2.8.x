...
public class NTMetaTileEntityCatalyticReformer extends RecipeMapMultiblockController {

    public NTMetaTileEntityCatalyticReformer(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, NTRecipeMaps.CATALYTIC_REFORMER_RECIPES);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new NTMetaTileEntityCatalyticReformer(metaTileEntityId);
    }
    ...
    protected ICubeRenderer getFrontOverlay() {
        return NTTextures.CATALYTIC_REFORMER_OVERLAY;
    }
