package com.onlyex.naxtech.api.recipe;

import com.onlyex.naxtech.api.gui.NTGuiTextures;
import com.onlyex.naxtech.api.recipe.builder.*;
import com.onlyex.naxtech.api.recipe.machines.*;
...
public class NTRecipeMaps {
    ...
    static {
        ...
        DRYER_RECIPES = new RecipeMap<>("dryer_recipes",  1,  2,  1,  1, new SimpleRecipeBuilder(), false)
        ...
        CRYSTALLIZATION_RECIPES = new RecipeMap<>("crystallizer_recipes",  3,  3,  3,  3, new SimpleRecipeBuilder(), false)
        ...
        CRYSTALLIZER_RECIPES = new RecipeMap<>("crystallization_recipes",  6,  1,  3,  0, new BlastRecipeBuilder(), false)
                .setProgressBar(GuiTextures.PROGRESS_BAR_CRYSTALLIZATION, ProgressWidget.MoveType.HORIZONTAL)
                .setSound(GTSoundEvents.FURNACE);
        ...
        //  CVD Unit Recipemap
        CVD_RECIPES = new RecipeMap<>("cvd_recipes",  2, 2,  3, 3, new GlassTierNoCoilTemperatureRecipeBuilder(), false)
                .setProgressBar(GuiTextures.PROGRESS_BAR_ARROW_MULTIPLE, ProgressWidget.MoveType.HORIZONTAL)
                .setSound(GTSoundEvents.COOLING);

        //  Plasma CVD Unit Recipemap
        PLASMA_CVD_RECIPES = new RecipeMap<>("plasma_cvd_recipes", 2, 2,  3, 3, new NoCoilTemperatureRecipeBuilder(), false)
                .setProgressBar(GuiTextures.PROGRESS_BAR_FUSION, ProgressWidget.MoveType.HORIZONTAL)
                .setSound(GTSoundEvents.COOLING);

        //  Laser CVD Unit Recipemap
        LASER_CVD_RECIPES = new RecipeMap<>("laser_cvd_recipes",  2,  2,  3,  3, new NoCoilTemperatureRecipeBuilder(), false)
                .setProgressBar(NTGuiTextures.PROGRESS_BAR_NANOSCALE, ProgressWidget.MoveType.HORIZONTAL)
                .setSound(GTSoundEvents.COOLING);

        //  Nanoscale Fabricator Recipemap
        MOLECULAR_BEAM_RECIPES = new RecipeMap<>("molecular_beam_recipes",  5, 1,  2, 1, new NoCoilTemperatureRecipeBuilder(), false)
                .setSlotOverlay(false, false, false, NTGuiTextures.NANOSCALE_OVERLAY_1)
                .setSlotOverlay(false, false, true, NTGuiTextures.NANOSCALE_OVERLAY_1)
                .setSlotOverlay(false, true, false, NTGuiTextures.NANOSCALE_OVERLAY_2)
                .setSlotOverlay(false, true, true, NTGuiTextures.NANOSCALE_OVERLAY_2)
                .setSlotOverlay(true, false, true, NTGuiTextures.NANOSCALE_OVERLAY_1)
                .setSlotOverlay(true, true, true, NTGuiTextures.NANOSCALE_OVERLAY_2)
                .setProgressBar(NTGuiTextures.PROGRESS_BAR_NANOSCALE, ProgressWidget.MoveType.HORIZONTAL)
                .setSound(GTSoundEvents.ELECTROLYZER);

        //  Sonicator Recipemap
        SONICATION_RECIPES = new RecipeMap<>("sonication_recipes",  0,  1,  2,  1, new GlassTierRecipeBuilder(), false)
                ...
                .setSlotOverlay(true, false, true, NTGuiTextures.FOIL_OVERLAY)
        ...
        FERMENTATION_TANK_RECIPES = new RecipeMap<>("fermentation_tank_recipes",  3,  3, 3,  3, new PHRecipeBuilder(), false)
                .setProgressBar(GuiTextures.PROGRESS_BAR_EXTRACT, ProgressWidget.MoveType.HORIZONTAL)
                .setSound(GTSoundEvents.CHEMICAL_REACTOR);
        ...
        COMPUTING_TERMINAL_RECIPES = new RecipeMap<>("computing_terminal_recipes",  4,  4, 0,  0, new ComputationRecipeBuilder(), false)
        ...
        //  Cyclotron Recipemap
        CYCLOTRON_RECIPES = new RecipeMap<>("cyclotron_recipes",  6,  6,  6,  6, new SimpleRecipeBuilder(), false)
                .setSlotOverlay(false, false, false, GuiTextures.IMPLOSION_OVERLAY_2)
                .setSlotOverlay(false, false, true, GuiTextures.IMPLOSION_OVERLAY_2)
        ...
        DRAGON_FUSION_UNIT_RECIPES = new RecipeMap<>("dragon_fusion_unit_recipes",  6,  1, 3,  1, new SimpleRecipeBuilder(), false)
