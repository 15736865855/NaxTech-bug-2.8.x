...
import com.onlyex.naxtech.common.metatileentities.multiblock.NTMetaTileEntityIndustrialFishingPond;
...
public class FishingPondLogic implements IWorkable {
    ...
    private final NTMetaTileEntityIndustrialFishingPond metaTileEntity;
    private int output;
    ...
    public FishingPondLogic(NTMetaTileEntityIndustrialFishingPond metaTileEntity, int minEnergyTier) {
