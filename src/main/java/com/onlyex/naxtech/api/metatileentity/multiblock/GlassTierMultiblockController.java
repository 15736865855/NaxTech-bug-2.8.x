...
public abstract class GlassTierMultiblockController extends RecipeMapMultiblockController {
    ...
    protected void formStructure(PatternMatchContext context) {
        ...
        this.glassTier = NTUniverUtil.getOrDefault(() -> type instanceof ITierGlassBlockState,
    ...
    protected void addDisplayText(List<ITextComponent> textList) {
        ...
        if (this.isStructureFormed() && glassTier > 0) {
            ...
            textList.add(0, new TextComponentTranslation("naxtech.machine.multiblock.glass_tier", new Object[]{glassTier, tierName}));
        }
    }
