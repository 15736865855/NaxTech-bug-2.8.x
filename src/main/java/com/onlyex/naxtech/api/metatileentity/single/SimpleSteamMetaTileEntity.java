package com.onlyex.naxtech.api.metatileentity.single;
...
public class SimpleSteamMetaTileEntity extends SteamMetaTileEntity {
    ...
    public SimpleSteamMetaTileEntity(ResourceLocation metaTileEntityId, RecipeMap<?> recipeMap, SteamProgressIndicator progressIndicator, ICubeRenderer renderer, boolean isBrickedCasing, boolean isHighPressure) {
        ...
        if (hasGhostCircuitInventory()) {
            this.circuitInventory = new GhostCircuitItemStackHandler(null);
...
/*    @Override TODO
    protected IItemHandlerModifiable createImportItemHandler() {
        ...
        return new NotifiableItemStackHandler(Objects.requireNonNull(workableHandler.getRecipeMap()).getMaxInputs(),1,this, false);
    }

    @Override
    protected IItemHandlerModifiable createExportItemHandler() {
        if (workableHandler == null) return new ItemStackHandler(0);
        return new NotifiableItemStackHandler(workableHandler.getRecipeMap().getMaxOutputs(), 1,this, true);
    }*/
    ...
    public FluidTankList createImportFluidHandler() {
        ...
        IFluidTank[] fluidImports = new IFluidTank[Objects.requireNonNull(workableHandler.getRecipeMap()).getMaxFluidInputs() + 1];
    ...
    protected FluidTankList createExportFluidHandler() {
        ...
        FluidTank[] fluidExports = new FluidTank[Objects.requireNonNull(workableHandler.getRecipeMap()).getMaxFluidOutputs()];
    ...
    protected TextureArea getCircuitSlotOverlay() {
        return NTGuiTextures.INT_CIRCUIT_OVERLAY_STEAM.get(isHighPressure);
    }
    ...
    protected TextureArea[] getOverlaysForSlot(boolean isOutputs, boolean isFluid) {
        return new TextureArea[] {isFluid ? NTGuiTextures.FLUID_SLOT_STEAM.get(isHighPressure) : GuiTextures.SLOT_STEAM.get(isHighPressure)};
    }
