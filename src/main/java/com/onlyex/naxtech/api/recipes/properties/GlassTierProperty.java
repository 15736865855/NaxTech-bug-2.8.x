package com.onlyex.naxtech.api.recipes.properties;
...
public class GlassTierProperty extends RecipeProperty<Integer> {
    ...
    public void drawInfo(@Nonnull Minecraft minecraft, int x, int y, int color, Object value) {
        minecraft.fontRenderer.drawString(I18n.format("naxtech.recipe.glass_tier", String.format("%s (%s)", castValue(value), GTValues.VN[castValue(value)])), x, y, color);
    }
}
